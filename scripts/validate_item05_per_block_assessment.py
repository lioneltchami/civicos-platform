...
DIMENSIONS = {"functional", "api", "data_audit", "error_failure", "security_cross_cutting", "testability", "dependency"}
...
def validate() -> dict:
    ...
    for marker in ("## Inherited Item 01–04 status", "## Scope-sensitive priority legend", "## Evidence-control matrix", "## Auditable Items 6–7 gate", "**Status at Stage 3:**"):
