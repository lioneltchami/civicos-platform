...
def test_runner_is_scoped_and_emits_safe_reports():
...
def test_layer_manifest_is_complete_and_references_exact_test_modules():
...
def test_documentation_defines_layers_fixture_policy_reports_and_boundary():
...
def test_operation_matrix_covers_required_operations_and_paths():
...
def test_makefile_exposes_canonical_runner_targets():
