...
Only push delivery is enabled in this local preparation. Email, SMS, poll, and inbound acknowledgement are deferred and must be represented as unsupported/deferred rather than successful delivery. The official suite has not been executed by this package; local validation and focused tests do not establish certification or testing-site readiness.
