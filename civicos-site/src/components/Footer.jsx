      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-sm">
              Django 5.2 and Wagtail-based government platform. Current public submission focus: the GovStack Content Management System building block.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: 'https://specs.govstack.global/content-management-system/2-description', label: 'GovStack CMS description' },
        ...
        <div className="mt-12 pt-8 border-t border-white/8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-sm">
            Prepared for a first submission to <a href="https://testing.govstack.global" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">testing.govstack.global</a>
          </p>
        </div>
      </div>
    </footer>
