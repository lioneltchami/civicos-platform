...
class DeterministicProvider(PaymentProvider):
    def __init__(
        self,
        outcomes: Iterable[ProviderResult] = (),
        statuses: Mapping[str, ProviderResult] | None = None,
    ) -> None:
    ...
    def submit(self, *, request_id: str, payment: Mapping[str, object]) -> ProviderResult:
        ...
        if not self._outcomes:
            return ProviderResult(
                ...
                code="NO_FIXTURE",
                message="No deterministic outcome supplied",
            )
    ...
    def get_status(
        ...
        return self._statuses.get(
            ...
            ProviderResult(
                ProviderOutcome.UNCERTAIN,
                code="STATUS_UNKNOWN",
                message="No deterministic status supplied",
            ),
        )
