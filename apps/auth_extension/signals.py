...
def _write_audit(event_type: str, outcome: str, user, request) -> None:
    """
...
def on_login_success(sender, request, user, **kwargs) -> None:
...
def on_login_failure(sender, credentials, request, **kwargs) -> None:
...
if _allauth_available:
    ...
    def on_user_signed_up(sender, request, user, **kwargs) -> None:
