...
def backfill_publisher_states(apps, schema_editor) -> None:  # noqa: ANN001
...
class Migration(migrations.Migration):
    dependencies = [("appointments", "0022_sch01_2a_cancel_only")]  # noqa: RUF012
    ...
    operations = [  # noqa: RUF012
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("unknown_handoff", "Unknown Handoff"),
                    ("published", "Published"),
                    ("exhausted", "Exhausted"),
                    ("cancelled", "Cancelled"),
                ],
        ...
        migrations.AddField(
            model_name="scheduleroutbox",
            name="publisher_failure_class",
            field=models.CharField(blank=True, default="", max_length=32),
        ),
        migrations.AddField(
            model_name="scheduleroutbox",
            name="publisher_state_changed_at",
