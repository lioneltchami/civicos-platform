...
class Migration(migrations.Migration):
    dependencies = [("appointments", "0018_alter_bookingauditlog_action_and_more")]  # noqa: RUF012
    ...
    operations = [  # noqa: RUF012
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=1,
                help_text="Incremented when an alert is re-armed or superseded to fence stale work.",
                verbose_name="Delivery generation",
            ),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="appointments.govstackalertschedule",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["status", "lease_expires_at"], name="appt_sched_lease_idx"
                    ),
                    models.Index(
                        fields=["owner_key", "status"], name="appt_sched_owner_status_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="outbox",
                        to="appointments.schedulerrecipientdelivery",
                    ),
                ),
            ],
            options={
                "indexes": [
                    models.Index(
                        fields=["published_at", "available_at"], name="appt_sched_outbox_idx"
                    )
                ]
            },
        ),
