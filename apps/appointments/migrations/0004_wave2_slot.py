    ...
    operations = [  # noqa: RUF012
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "spaces_used",
                    models.PositiveSmallIntegerField(default=0, verbose_name="Spaces used"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "is_walk_in_slot",
                    models.BooleanField(default=False, verbose_name="Walk-in slot"),
                ),
                (
                    "video_join_url_citizen",
                    models.URLField(blank=True, verbose_name="Citizen video join URL"),
                ),
                (
                    "video_join_url_staff",
                    models.URLField(blank=True, verbose_name="Staff video join URL"),
                ),
                (
                    "video_meeting_id",
                    models.CharField(blank=True, max_length=200, verbose_name="Video meeting ID"),
                ),
                (
                    "video_provider",
                    models.CharField(blank=True, max_length=20, verbose_name="Video provider"),
                ),
        ...
        migrations.AddIndex(
            model_name="slot",
            index=models.Index(
                fields=["location", "start_datetime", "status"], name="appt_slot_loc_dt_status"
            ),
        ),
        migrations.AddIndex(
            model_name="slot",
            index=models.Index(
                fields=["effective_start", "effective_end"], name="appt_slot_eff_start_end"
            ),
        ),
