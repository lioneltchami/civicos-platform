...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("exception_type", models.CharField(
                    max_length=20,
                    choices=[("holiday","Public Holiday / Day Off"),("leave","Sick / Personal Leave"),("override","Override Hours"),("training","Training / Conference")],
                    verbose_name="Exception type",
                )),
                ("override_start_time", models.TimeField(blank=True, null=True, verbose_name="Override start time")),
                ("override_end_time", models.TimeField(blank=True, null=True, verbose_name="Override end time")),
                ("note_internal", models.CharField(blank=True, max_length=200, verbose_name="Internal note")),
                ("staff", models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["staff", "day_of_week", "valid_from"], name="appt_avail_staff_dow_from"),
        ),
