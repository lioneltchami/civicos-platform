    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(help_text='Permanent URL at which this version of the Policy can be read.')),
                ('jurisdiction', models.CharField(blank=True, max_length=100)),
                ('industry_sector', models.CharField(blank=True, max_length=100)),
                ('data_retention_period_days', models.PositiveIntegerField(blank=True, help_text='How long personal data is retained (days).', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('schema_name', models.CharField(db_index=True, help_text='E.g. "DataAgreement", "Policy", "ConsentRecord"', max_length=100)),
                ('object_id', models.CharField(db_index=True, help_text='PK of the object that was serialized.', max_length=64)),
                ('serialized_snapshot', models.JSONField(help_text='Full serialized content of the object at revision time.')),
                ('serialized_hash', models.CharField(help_text='SHA-256 hash of serialized_snapshot (JSON, sort_keys=True).', max_length=64)),
                ('timestamp', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('authorized_by_other', models.CharField(blank=True, help_text='Reference to an admin/system that created this revision.', max_length=255)),
                ('predecessor_hash', models.CharField(blank=True, help_text='serializedHash of the previous revision for this object.', max_length=64)),
                ('authorized_by_individual', models.ForeignKey(blank=True, help_text='The individual who authorized this revision.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consent_revisions_individual', to=settings.AUTH_USER_MODEL)),
                ('successor', models.OneToOneField(blank=True, help_text='This revision is no longer the latest — refer to successor.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='predecessor', to='consent.consentrevision')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['schema_name', 'object_id', 'timestamp'], name='consent_rev_schema__f5b8a2_idx'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('payload_url', models.URLField(help_text='The URL to which the webhook payload will be POSTed.')),
                ...
                ('is_disabled', models.BooleanField(default=False, help_text='If True, this webhook will not receive events.')),
                ('secret_key', models.CharField(help_text='HMAC secret key used to sign payloads (SHA-256).', max_length=255)),
                ('subscribed_events', models.JSONField(default=list, help_text='List of event type strings this webhook is subscribed to.')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='consentcategory',
            name='version',
            field=models.CharField(blank=True, default='1.0.0', help_text='Data Agreement version string.', max_length=50),
        ),
        migrations.AddField(
            model_name='consentcategory',
            name='data_use',
            field=models.CharField(
                blank=True,
                choices=[('', 'Not specified'), ('data_source', 'Data Source'), ('data_using_service', 'Data Using Service')],
                default='',
                max_length=30,
            ),
        ),
        migrations.AddField(
            model_name='consentcategory',
            name='dpia',
            field=models.TextField(blank=True, help_text='Data Protection Impact Assessment (DPIA) summary.'),
        ),
        migrations.AddField(
            model_name='consentcategory',
            name='forgettable',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='Name of the data controller organisation.', max_length=255),
        ),
        migrations.AddField(
            model_name='consentcategory',
            name='controller_url',
