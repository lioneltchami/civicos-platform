...
urlpatterns = [
    ...
    path(
        "config/policy/<str:policy_id>/",
        v.ConfigPolicyDetailView.as_view(),
        name="gs-policy-detail",
    ),
    path(
        "config/policy/<str:policy_id>/revisions/",
        v.ConfigPolicyRevisionsView.as_view(),
        name="gs-policy-revisions",
    ),
    # -----------------------------------------------------------------------
    # CONFIG — DataAgreement (ConsentCategory uses integer PK)
    # -----------------------------------------------------------------------
    path(
        "config/data-agreements/", v.ConfigDataAgreementCollectionView.as_view(), name="gs-da-list"
    ),
    path("config/data-agreement/", v.ConfigDataAgreementCreateView.as_view(), name="gs-da-create"),
    path(
        "config/data-agreement/<str:data_agreement_id>/",
        v.ConfigDataAgreementDetailView.as_view(),
        name="gs-da-detail",
    ),
    # -----------------------------------------------------------------------
    ...
    path(
        "config/individuals/",
        v.ConfigIndividualCollectionView.as_view(),
        name="gs-config-individual-list",
    ),
    path(
        "config/individual/",
        v.ConfigIndividualCreateView.as_view(),
        name="gs-config-individual-create",
    ),
    path(
        "config/individual/<str:individual_id>/",
        v.ConfigIndividualDetailView.as_view(),
        name="gs-config-individual-detail",
    ),
    # -----------------------------------------------------------------------
    # CONFIG — Webhook (uuid)
    # -----------------------------------------------------------------------
    ...
    path(
        "config/webhook/<str:webhook_id>/payload/",
        v.ConfigWebhookPayloadView.as_view(),
        name="gs-webhook-payload",
    ),
    path(
        "config/webhook/<str:webhook_id>/",
        v.ConfigWebhookDetailView.as_view(),
        name="gs-webhook-detail",
    ),
    # -----------------------------------------------------------------------
    ...
    path(
        "service/individuals/",
        v.ServiceIndividualCollectionView.as_view(),
        name="gs-service-individual-list",
    ),
    path(
        "service/individual/",
        v.ServiceIndividualCreateView.as_view(),
        name="gs-service-individual-create",
    ),
    ...
    path(
        "service/individual/<str:individual_id>/",
        v.ServiceIndividualDetailView.as_view(),
        name="gs-service-individual-detail",
    ),
    # SERVICE — DataAgreement (read-only for individuals; int PK)
    path(
        "service/data-agreement/<str:data_agreement_id>/",
        v.ServiceDataAgreementDetailView.as_view(),
        name="gs-service-da-detail",
    ),
    # SERVICE — Policy (read-only for individuals; uuid)
    path(
        "service/policy/<str:policy_id>/",
        v.ServicePolicyDetailView.as_view(),
        name="gs-service-policy-detail",
    ),
    ...
    path(
        "service/verification/consent-record/<str:consent_record_id>/",
    ...
    path(
        "service/individual/record/consent-record/<str:consent_record_id>/",
    ...
    path(
        "service/individual/record/data-agreement/<str:data_agreement_id>/all/",
        v.ServiceIndividualDataAgreementAllConsentRecordsView.as_view(),
        name="gs-cr-by-da-all",
    ),
    path(
        "service/individual/record/data-agreement/<str:data_agreement_id>/",
        v.ServiceIndividualDataAgreementConsentRecordView.as_view(),
        name="gs-cr-by-da",
    ),
    # SERVICE — ConsentRecord Signature (POST create, PUT update)
    path(
        "service/individual/record/consent-record/<str:consent_record_id>/signature/",
    ...
    path(
        "audit/consent-record/<str:consent_record_id>/",
        v.AuditConsentRecordDetailView.as_view(),
        name="gs-audit-cr-detail",
    ),
    path("audit/data-agreements/", v.AuditDataAgreementListView.as_view(), name="gs-audit-da-list"),
    path(
        "audit/data-agreement/<str:data_agreement_id>/",
        v.AuditDataAgreementDetailView.as_view(),
        name="gs-audit-da-detail",
    ),
