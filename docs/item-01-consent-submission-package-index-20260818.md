# Item 01 Consent Internal Submission Package Index

| Artifact | Location | Status |
|---|---|---|
| Authority/version record | `docs/item-01-consent-authority-20260818.md` | complete |
| Published operation matrix | JSON and Markdown in `docs/` | generated; rows remain partial until tested |
| Model/lifecycle mapping | `docs/item-01-consent-model-mapping-20260818.md` | complete as bounded assessment |
